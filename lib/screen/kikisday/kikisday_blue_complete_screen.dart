...
class KikisdayBlueCompleteScreen extends StatefulWidget {
  ...
  KikisdayBlueCompleteScreen({Key? key, required this.currentNumber}) : super(key: key);

  @override
  State<KikisdayBlueCompleteScreen> createState() => _KikisdayBlueCompleteScreenState();
}

class _KikisdayBlueCompleteScreenState extends State<KikisdayBlueCompleteScreen> {
  late Timer _timer;
