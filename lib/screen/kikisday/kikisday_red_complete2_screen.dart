...
class KikisdayRedComplete2Screen extends StatefulWidget {
  ...
  KikisdayRedComplete2Screen({Key? key, required this.currentNumber}) : super(key: key);

  @override
  State<KikisdayRedComplete2Screen> createState() => _KikisdayRedComplete2ScreenState();
}

class _KikisdayRedComplete2ScreenState extends State<KikisdayRedComplete2Screen> {
  late Timer _timer;
