...
class KikisdayTalmudStory2Screen extends StatefulWidget {
  ...
  @override
  State<KikisdayTalmudStory2Screen> createState() => _KikisdayTalmudStory2ScreenState();
}

class _KikisdayTalmudStory2ScreenState extends State<KikisdayTalmudStory2Screen> {
  late Timer _timer;
      ...
      body: Stack(
        children: <Widget>[
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            child: Image.asset('assets/kikisday/talmud_story_2.png',
