...
class Kikisday9Screen extends StatefulWidget {
  const Kikisday9Screen({super.key, required int currentNumber});
      ...
      body: Stack(
        children: <Widget>[
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            child: Image.asset('assets/kikisday/kikisday_9_text.png',
              ...
              child: GestureDetector(
                onTap: () {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => KikisdayRedCompleteScreen(
                          currentNumber: 9,
                        )),
                  );
                },
