...
class KikisdayRandomDice3Screen extends StatefulWidget {
  ...
  KikisdayRandomDice3Screen({Key? key, required this.currentNumber, required this.userId}) : super(key: key);
...
class _KikisdayRandomDice3ScreenState extends State<KikisdayRandomDice3Screen> {
  ...
  void _initializeAndPlayVideo() {
    _controller = VideoPlayerController.asset('assets/kikisday/kikisday_3_dice_${randomNumber}.mp4')
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
