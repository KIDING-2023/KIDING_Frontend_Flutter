...
class KikisdayTalmudStory3Screen extends StatefulWidget {
  ...
  @override
  State<KikisdayTalmudStory3Screen> createState() => _KikisdayTalmudStory3ScreenState();
}

class _KikisdayTalmudStory3ScreenState extends State<KikisdayTalmudStory3Screen> {
  late Timer _timer;
      ...
      body: Stack(
        children: <Widget>[
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            child: Image.asset('assets/kikisday/talmud_story_3.png',
                width: 339.79, height: 476.3),
          ),
        ],
      ),
    );
