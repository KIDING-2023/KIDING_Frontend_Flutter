...
class KikisdayPurpleCompleteScreen extends StatefulWidget {
  ...
  KikisdayPurpleCompleteScreen({Key? key, required this.currentNumber}) : super(key: key);

  @override
  State<KikisdayPurpleCompleteScreen> createState() => _KikisdayPurpleCompleteScreenState();
}

class _KikisdayPurpleCompleteScreenState extends State<KikisdayPurpleCompleteScreen> {
  late Timer _timer;
      ...
      body: Stack(
        children: <Widget>[
          ...
          Positioned(
            ...
            left: 0,
            right: 0,
            child: Image.asset('assets/kikisday/purple_complete.png',
