...
class SpaceVenusCompleteScreen extends StatefulWidget {
  ...
  const SpaceVenusCompleteScreen({super.key, required this.currentNumber, required this.userId});
...
class _SpaceVenusCompleteScreenState extends State<SpaceVenusCompleteScreen> {
  ...
  void _navigateToRandomDiceScreen() {
    switch (widget.currentNumber) {
      ...
      default:
        nextScreen =
            SpaceRandomDiceScreen(currentNumber: widget.currentNumber, userId: widget.userId,);
        _answerSuccess();
        break;
    }
