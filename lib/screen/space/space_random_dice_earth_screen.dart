...
class SpaceRandomDiceEarthScreen extends StatefulWidget {
  ...
  const SpaceRandomDiceEarthScreen({super.key, required this.currentNumber});

  @override
  State<SpaceRandomDiceEarthScreen> createState() => _SpaceRandomDiceEarthScreenState();
}

class _SpaceRandomDiceEarthScreenState extends State<SpaceRandomDiceEarthScreen> {
  ...
  void _initializeAndPlayVideo() {
    _controller = VideoPlayerController.asset(
        'assets/space/dice_${randomNumber}_earth.mp4')
      ..initialize().then((_) {
        setState(() {});
        _controller.play();
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          ...
          Positioned.fill(
            child: Image.asset(
              'assets/space/earth_blur_bg.png',
              fit: BoxFit.cover,
            ),
          ),
